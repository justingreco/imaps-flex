...
package com.raleigh.components.utils
{
	 ...
	 */
	public class CustomIndeterminateProgressSkin extends Border
	{		
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 *  @productversion Flex 4
		 */
		public function CustomIndeterminateProgressSkin()
		{
			super();
		}	
		...
		private static var colors:Array = [0xFF0000, 0x808080];
