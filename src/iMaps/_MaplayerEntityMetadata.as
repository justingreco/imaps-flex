...
[ExcludeClass]
internal class _MaplayerEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "name", "url", "visible", "type", "minscale", "alpha", "visibleLayers", "identifiable", "identifiableLayers", "category");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "name", "url", "visible", "type", "minscale", "alpha", "visibleLayers", "identifiable", "identifiableLayers", "category");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "name", "url", "visible", "type", "minscale", "alpha", "visibleLayers", "identifiable", "identifiableLayers", "category");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "name", "url", "visible", "type", "minscale", "alpha", "visibleLayers", "identifiable", "identifiableLayers", "category");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "name", "url", "visible", "type", "minscale", "alpha", "visibleLayers", "identifiable", "identifiableLayers", "category");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Maplayer";
    ...
    model_internal var _instance:_Super_Maplayer;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _MaplayerEntityMetadata(value : _Super_Maplayer)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Maplayer");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Maplayer");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Maplayer");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Maplayer");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Maplayer");
        }
