 ...
 * of this value object you may modify the generated sub-class of this class - Bookmarks.as.
 */
...
[ExcludeClass]
public class _Super_Bookmarks extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _BookmarksEntityMetadata;
     ...
     * properties
     */
    private var _internal_bookmark : ArrayCollection;
    model_internal var _internal_bookmark_leaf:iMaps.Bookmark;
    ...
    public function _Super_Bookmarks()
    {
        _model = new _BookmarksEntityMetadata(this);
    ...
    public function get bookmark() : ArrayCollection
    {
    ...
    public function set bookmark(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_bookmark;
        if (oldValue !== value)
        {
            ...
            {
                _internal_bookmark = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_bookmark = null;
            }
            else
            {
                throw new Error("value of bookmark must be a collection");
            }
    ...
    model_internal function setterListenerBookmark(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerBookmark);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BookmarksEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BookmarksEntityMetadata) : void
    {
        var oldValue : _BookmarksEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfBookmark : ArrayCollection;
