 ...
 * of this value object you may modify the generated sub-class of this class - Category_type.as.
 */
...
[ExcludeClass]
public class _Super_Category_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.SubCategory_type.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _Category_typeEntityMetadata;
    ...
    model_internal var _internal_SubCategory_leaf:valueObjects.SubCategory_type;
    ...
    public function _Super_Category_type()
    {
        _model = new _Category_typeEntityMetadata(this);
    ...
    model_internal function setterListenerSubCategory(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerSubCategory);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Category_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Category_typeEntityMetadata) : void
    {
        var oldValue : _Category_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfSubCategory : ArrayCollection;
