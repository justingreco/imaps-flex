 ...
 * of this value object you may modify the generated sub-class of this class - Queries.as.
 */
...
[ExcludeClass]
public class _Super_Queries extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.Query.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _QueriesEntityMetadata;
     ...
     * properties
     */
    private var _internal_query : valueObjects.Query;
    ...
    public function _Super_Queries()
    {
        _model = new _QueriesEntityMetadata(this);
    ...
    public function get query() : valueObjects.Query
    {
    ...
    public function set query(value:valueObjects.Query) : void
    {
        var oldValue:valueObjects.Query = _internal_query;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _QueriesEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _QueriesEntityMetadata) : void
    {
        var oldValue : _QueriesEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfQuery : valueObjects.Query;

    model_internal function _doValidationForQuery(valueIn:Object):Array
    {
        var value : valueObjects.Query = valueIn as valueObjects.Query;
